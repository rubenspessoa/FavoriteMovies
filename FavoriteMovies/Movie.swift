...
class Movie {
    ...
    init(Actors: String?, Awards: String?, Country: String?, Director: String?, Genre: String?, Language: String?, Plot: String?, Poster: String?, Released: String?, Runtime: String?, Title: String?, Writer: String?, Year: String?, imdbID: String?, imdbRating: String?, imdbVotes: String?) {
...
class MovieDAO {
    ...
    func getMovies(byName: String, completionHandler: @escaping (([Movie]) -> ())) {
        ...
        getMoviesJSON(byName: byName, completionHandler: {
            ...
            if let json = mvJSON {
                if (json["Error"] != nil) {
                    //throw MovieDAOError.MovieNotFound
                    return
                } else {
                ...
                return
                //throw MovieDAOError.CannotReachAPI
            }
        })
    }
}
